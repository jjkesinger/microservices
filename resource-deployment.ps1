# WIP
param ($server, $sqlusr, [SecureString]$sqlpassword, $resourceGroup, $location, [SecureString]$servicebusnamespace, [SecureString]$databasename)
# $ = "P@ssword"
# $ = "adminuser"
# $ = "nsp-esc-dev"
# $ = "microservice"
...
$sqlservername = ConvertTo-SecureString $server -AsPlainText -Force
$sqluser = ConvertTo-SecureString $sqlusr -AsPlainText -Force
